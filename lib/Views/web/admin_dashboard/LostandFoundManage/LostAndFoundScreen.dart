  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('lost_found').snapshots(),
              ...
              return Card(
                ...
                child: ListTile(
                  leading: GestureDetector(
                    onTap: () => launchURL(item.imageUrl), // Launch image URL in browser
                  ...
                  subtitle: Column(
                    ...
                    children: [
                      ...
                      Text('Date: ${formatDate(item.timestamp)}'), // Display formatted date and time
                    ],
                  ),
                  trailing: Row(
